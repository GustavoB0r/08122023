...
// Usando SwingWorker para realizar um calculo longo com resultados exibidos em uma GUI.
...
public class FibonacciNumbers  extends JFrame{
            ...
            new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    ...
                    try {
                        ...
                        fibonacciJLabel.setText("Enter am integer");
                        return;
                    }
    ...
    //metodo main indica a execucao de programa
    public static void main(String[] args) {
        FibonacciNumbers application = new FibonacciNumbers();
        application.setDefaultCloseOperation(EXIT_ON_CLOSE);
    }
} // fim da clasee Fibonacci Numbers
